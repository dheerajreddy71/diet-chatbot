...
if st.session_state.page == "Login":
    ...
    menu_items = {
       ...
       "Desserts": {
        ...
        "Chicken Alfredo": ["contains dairy"],
        "Beef Stroganoff": ["contains dairy"],
        "Vegetarian Lasagna": ["vegetarian"],
        "Grilled Salmon": ["gluten-free"],
        "Stuffed Bell Peppers": ["vegan"],
        "Beef Tacos": ["contains gluten"],
        "Chicken Parmesan": ["contains dairy"],
        "Eggplant Parmesan": ["vegetarian"],
        "Spaghetti Carbonara": ["contains dairy"],
        "Lentil Curry": ["vegan"],
        "Shrimp Scampi": ["contains gluten"],
        "BBQ Chicken": ["contains gluten"],
        "Vegan Chili": ["vegan"],
        "Stuffed Zucchini Boats": ["vegan"],
        "Pork Schnitzel": ["contains gluten"],
        "Thai Green Curry": ["vegan"],
        "Chicken Teriyaki": ["contains gluten"],
        "Vegetable Stir-Fry": ["vegan"],
        "Beef Wellington": ["contains gluten"],
        "Spinach & Ricotta Stuffed Shells": ["vegetarian"],
        "Coconut Curry Chicken": ["contains dairy"],
        "Grilled Portobello Mushrooms": ["vegan"],
        "Baked Ziti": ["contains dairy"],
        "Mushroom Risotto": ["vegetarian"],
        "Chicken Fajitas": ["contains gluten"],
        "Shrimp and Grits": ["contains dairy"],
        "Roast Beef": ["gluten-free"],
        "Vegetable Korma": ["vegan"],
        "Lamb Chops": ["gluten-free"],
        "Fish Tacos": ["contains gluten"],
        "Vegetable Stir-Fry with Tofu": ["vegan"],
        "Turkey Meatballs": ["contains gluten"],
        "Pumpkin Risotto": ["vegetarian"],
        "Beef Chili": ["contains gluten"],
        "Pasta Primavera": ["vegetarian"],
        "Chicken Marsala": ["contains gluten"],
        "Vegan Enchiladas": ["vegan"],
        "Seafood Paella": ["contains gluten"],
        "Cheese Ravioli": ["vegetarian"],
        "Grilled Veggie Platter": ["vegan"],
        "Pork Ribs": ["contains gluten"],
        "Vegetable Lasagna": ["vegetarian"],
        "Chicken and Rice Casserole": ["contains dairy"],
        "Vegan Pad Thai": ["vegan"],
        "Pasta with Marinara Sauce": ["vegetarian"],
        "Beef Burritos": ["contains gluten"],
        "Sweet Potato & Black Bean Tacos": ["vegan"]
    },
    "Drinks": {
